...
@testset "Static accelerator path" begin
    ...
    @test typeof(config) == FlashConfig
    @test flash_storage(eos, c, SSIFlash(), config) isa StaticConfig
